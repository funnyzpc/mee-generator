...
var module={
    ...
    api:{
        /* 列表分页查询：GET请求 */
        "page": ctxPath+"/code_gen3/preview/",
        "base": ctxPath+"/code_gen3",

//        /* 添加：POST请求 */
//        add: "/code_gen3/add",
//        /* 删除: DELETE请求 */
//        del: "/code_gen3/delete",
//        /* 修改: PUT请求 */
//        mod: "/code_gen3/update",
    },
...
function doPreview(item,idx,elem){
    ...
    window.open(ctxPath+'/code_gen3/gen3_preview.html?table_id='+item.table_id,'_blank','channelmode=yes,fullscreen=yes')
};
