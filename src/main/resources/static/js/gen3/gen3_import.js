...
var module={
    ...
    api:{
        /* 列表分页查询：GET请求 */
        "page": ctxPath+"/code_gen3_import/list",
        "base": ctxPath+"/code_gen3_import",
//        /* 添加：POST请求 */
//        add: "/code_gen3_import/add",
//        /* 删除: DELETE请求 */
//        del: "/code_gen3_import/delete",
//        /* 修改: PUT请求 */
//        mod: "/code_gen3_import/update",
    },
...
function saveTable(){
    ...
    FetchUtils.fetchPost(ctxPath+"/code_gen3_import/save_table",table_list,function(res){
