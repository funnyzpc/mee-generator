...
function saveData(){
    // document.querySelectorAll("#data-list tbody tr")[0].querySelectorAll("input,select,textarea")
    ...
    fetchPutJson(ctxPath+"/code_gen3/gen3_field/update",data_list,function(res){
        if( res && res.status===1 ){
            alert(res.msg);
            // 刷新页面
