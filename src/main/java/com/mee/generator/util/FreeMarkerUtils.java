...
public class FreeMarkerUtils {
     ...
     * java类型
     */
    public static final Map<String,String> JAVA_TYPE = new ConcurrentHashMap<String,String>(){{
        put("String","java.lang.String");
        put("Integer","java.lang.Integer");
        put("Long","java.lang.Long");
        put("Serializable","java.io.Serializable");

        put("LocalDateTime","java.time.LocalDateTime");
        put("JsonFormat","com.fasterxml.jackson.annotation.JsonFormat");
        ...
        put("LocalDateTimeSerializer","com.fasterxml.jackson.datatype.jsr310.ser.LocalDateTimeSerializer");
        put("LocalDateSerializer","com.fasterxml.jackson.datatype.jsr310.ser.LocalDateSerializer");
        put("DateTimeFormat","org.springframework.format.annotation.DateTimeFormat");
     ...
     * mysql关键字
     */
    public static String[] MYSQL_KEYWORDS={"name","type","date","unit","password","show","like","comment"};
    /**
     * postgresql关键字
     */
    public static String[] POSTGRESQL_KEYWORDS={"desc","add","abs","bigint","public","return"};
    /**
     * oracle关键字
     */
    public static String[] ORACLE_KEYWORDS={"desc","name"};
    /**
     * sqlserver(ms)关键字
     */
    public static String[] SQLSERVER_KEYWORDS={"file","like","index"};
...
//        templates.add("ftl/java/sub-domain.java.ftl");
     ...
     * @return 模板列表
     */
    public static List<String> getTemplateList2( ){
        List<String> templates = new ArrayList<String>(8);
        // java
        templates.add("ftl2/java/entity.java");
        templates.add("ftl2/java/mapper.java");
        templates.add("ftl2/java/service.java");
        templates.add("ftl2/java/serviceImpl.java");
        templates.add("ftl2/java/controller.java");
        templates.add("ftl2/java/dto.java");
        // mybatis xml
        templates.add("ftl2/xml/mapper.xml");
        // 前端
        templates.add("ftl2/web/page.html");
        templates.add("ftl2/web/page.js");
     ...
     * @return
     */
    public static List<String> getTemplateList3( ){
        List<String> templates = new ArrayList<String>(32);
        // other
        templates.add("ftl3/java/Entity.java");
        // mgm
        templates.add("ftl3/java/AddRequest.java");
        templates.add("ftl3/java/EditStatusRequest.java");
        templates.add("ftl3/java/ListRequest.java");
        templates.add("ftl3/java/PrimaryRequest.java");
        templates.add("ftl3/java/UpdateRequest.java");
        templates.add("ftl3/java/CreateFlow.java");
        templates.add("ftl3/java/EditStatusFlow.java");
        templates.add("ftl3/java/UpdateFlow.java");
        templates.add("ftl3/java/DeleteFlow.java");
        templates.add("ftl3/java/DeleteInvoker.java");
        templates.add("ftl3/java/EditStatusInvoker.java");
        ...
        templates.add("ftl3/java/Response.java");
        templates.add("ftl3/java/Service.java");
        templates.add("ftl3/java/ServiceImpl.java");

        // online
        templates.add("ftl3/java/GetInfoRequest.java");
        templates.add("ftl3/java/GetListRequest.java");
        templates.add("ftl3/java/OnlineController.java");
        templates.add("ftl3/java/OnlinePreService.java");
        templates.add("ftl3/java/OnlinePreServiceImpl.java");
        templates.add("ftl3/java/InfoResponse.java");

        return templates;
    }

    public  static freemarker.template.Configuration initFreemarker() {
        Configuration cfg = new Configuration(Configuration.VERSION_2_3_31);
        cfg.setDefaultEncoding("UTF-8");
        cfg.setLocale(Locale.CHINA);
        cfg.setClassForTemplateLoading(MeeGeneratorApplication.class, "/");
        return cfg;
    }
